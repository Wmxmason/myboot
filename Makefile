##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.8.0-B50] date: [Tue May 19 17:15:32 CST 2026]
##########################################################################################################################
...
C_SOURCES := app \
			...
			platform/syscall
C_SOURCES := $(foreach dir,$(C_SOURCES),$(wildcard $(dir)/*.c))
# ASM sources
ASM_SOURCES :=  \
platform/cmsis/device/startup_stm32f407xx.s \
app/jumpapp.s
...
C_INCLUDES := app \
			 ...
			 platform/syscall
C_INCLUDES := $(foreach dir,$(C_INCLUDES),-I$(dir))
